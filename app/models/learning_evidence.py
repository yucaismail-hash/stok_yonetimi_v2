...
class LearningEvidence(BaseModel):
    ...
    __table_args__ = (
        ...
        CheckConstraint("event_type IN ('ACTUAL_ACCEPTED', 'ACTUAL_CORRECTED', 'FORECAST_EVALUATED', 'CHAMPION_PROMOTED', 'CHAMPION_ROLLED_BACK', 'RETRAINING_COMPLETED')", name="ck_learning_evidence_event_type"),
