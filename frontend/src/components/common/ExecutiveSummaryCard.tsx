...
// Stokonomi Design System - AI Executive Summary Card
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography variant="caption" sx={{ color: '#9e9e9e', fontSize: '0.65rem' }}>
              Analiz tamamlandığında AI özeti burada görünecek.
            </Typography>
          </Box>
        </Box>
      </Paper>
          ...
          <Grid container spacing={1} sx={{ mt: 0.5 }}>
            <Grid size={{ xs: 6, sm: 2.4 }}>
              <Box sx={{ textAlign: 'center', p: 0.5, bgcolor: 'rgba(255,255,255,0.6)', borderRadius: 1 }}>
                <Typography variant="caption" sx={{ fontSize: '0.45rem', color: '#6b7280' }}>📦 Ürün</Typography>
            ...
            <Grid size={{ xs: 6, sm: 2.4 }}>
              <Box sx={{ textAlign: 'center', p: 0.5, bgcolor: 'rgba(255,255,255,0.6)', borderRadius: 1 }}>
                <Typography variant="caption" sx={{ fontSize: '0.45rem', color: '#6b7280' }}>📈 Artır</Typography>
            ...
            <Grid size={{ xs: 6, sm: 2.4 }}>
              <Box sx={{ textAlign: 'center', p: 0.5, bgcolor: 'rgba(255,255,255,0.6)', borderRadius: 1 }}>
                <Typography variant="caption" sx={{ fontSize: '0.45rem', color: '#6b7280' }}>📉 Azalt</Typography>
            ...
            <Grid size={{ xs: 6, sm: 2.4 }}>
              <Box sx={{ textAlign: 'center', p: 0.5, bgcolor: 'rgba(255,255,255,0.6)', borderRadius: 1 }}>
                <Typography variant="caption" sx={{ fontSize: '0.45rem', color: '#6b7280' }}>✅ Koru</Typography>
            ...
            <Grid size={{ xs: 6, sm: 2.4 }}>
              <Box sx={{ textAlign: 'center', p: 0.5, bgcolor: 'rgba(255,255,255,0.6)', borderRadius: 1 }}>
                <Typography variant="caption" sx={{ fontSize: '0.45rem', color: '#6b7280' }}>⭐ En İyi Metot</Typography>
