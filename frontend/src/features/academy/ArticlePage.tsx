...
export default function ArticlePage() {
  ...
  // Article not found - show placeholder with noindex
  ...
  const canonical = `https://stokonomi.com/akademi/${article.slug}`;
  const seoTitle = article.seoTitle || article.title;
  const seoDescription = article.seoDescription || article.description;

  // Extract FAQ from article sections
  const faqSection = article.sections.find((section) => section.type === 'faq');
  ...
  return (
    <>
      <Seo
        ...
        ogImageAlt="Stokonomi Akademi - Stok Yönetimi Nedir?"
        ...
        faqs={faqs}
        breadcrumbs={[
          { name: 'Ana Sayfa', url: 'https://stokonomi.com/' },
          { name: 'Akademi', url: 'https://stokonomi.com/akademi' },
