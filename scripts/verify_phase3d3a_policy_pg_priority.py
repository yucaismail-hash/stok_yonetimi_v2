...
def main():
 try:
  ...
  _,r=evaluate(build('priority_multi',supplier='LATE_PRONE',event=True,backtest='weak_validation',simulation='stockout_risk'));assert types(r)==('REVIEW_SAFETY_STOCK','REVIEW_FORECAST','REVIEW_SUPPLIER','MONITOR_EVENT_RISK') and r.agreement_status=='MIXED'
